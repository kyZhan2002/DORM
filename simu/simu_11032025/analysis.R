...
data_dir <- here('simu', 'simu_11032025', 'data')
output_dir <- here('simu', 'simu_11032025', 'results')
...
worst_summary = worst_summary[order(worst_summary$`true-s`),]
## Save summary tables
