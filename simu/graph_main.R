...
data <- data.frame(
  ...
  DORM = c(21.20,27.20,33.35, 37.89, 41.23,44.89, 47.56, 49.02, 50.01, 50.86),
  DORM_true = c(20.30, 26.70, 32.92, 37.70, 41.43, 45.06, 47.31,48.93, 50.60, 51.67),
  DORM_P0.05 = c(21.56, 27.93, 34.09, 38.82, 43.19, 46.06, 48.55, 50.41,51.52, 53.08),
  DORM_P0.1 = c(21.56,30.16,35.59,41.21, 44.62, 48.24, 50.21, 51.41,52.77, 53.64),
  ...
  Joint_mixing = c(19.92, 26.70, 33.16, 40.52, 47.42, 53.95, 61.51, 68.77, 75.30, 82.92)
)
...
df_mix0 <- data.frame(
  ...
  # RA = c(19.78, 10.60578116, 15.10092016, 19.89342186, 24.52878898),
  Maximin = c(54.72, 54.77, 54.91, 54.93, 55.04, 55.07, 55.22, 55.37, 55.50, 55.37),
  Joint_mixing = c(19.82, 26.60, 33.06, 40.42, 47.32, 53.95, 61.41, 68.67, 75.20, 82.82)
)
...
df_mix1 <- data.frame(
  ...
  DORM = c(21.48710136, 27.4897697, 32.70937432, 37.08811541, 40.71248378, 
  ...
  Joint_mixing = c(21.33602029, 27.99031054, 34.62651952, 41.2395427, 47.87275795, 
...
df_mix2 <- data.frame(
  Index = c(0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5),
  DORM = c(21.16466798, 26.34179251, 30.65817614, 34.40882817, 
  ...
  Joint_mixing = c(19.72087579, 24.13174846, 28.39639391, 32.7484552, 
...
df_mix3 <- data.frame(
  Index = c(0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5),
  DORM = c(59.19474442, 59.47648462, 59.42879475, 59.1501148, 
  ...
  Joint_mixing = c(59.59803586, 60.66489209, 61.72162603, 62.90758141, 
...
df_L2 <- data.frame(
  Index = c(0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5),
  DORM = c(7.458512385, 7.698833652, 7.840798662, 7.901392027, 7.880774587, 
  ...
  Joint_mixing = c(8.059515737, 8.982816495, 9.876406009, 10.75552399, 11.60063427, 
...
df_L10 <- data.frame(
  Index = c(0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5),
  DORM = c(19.60830629, 26.38578721, 32.32611946, 37.33531571, 
  ...
  Joint_mixing = c(18.98232904, 25.93669119, 33.016942, 39.97411933, 
...
df_high <- data.frame(
  ...
  DORM = c(7.7129, 7.6297, 7.7256, 7.6415),
...
df_highw <- data.frame(
  Index = c(50, 100, 150, 200),
  DORM = c(14.03, 14.02, 14.03, 14.04),
